...
* ^url = "http://spezi.stanford.edu/fhir/ValueSet/ios-autocapitalization-type-valueset"
* ^version = "1.0.0"
* ^status = #active
* ^date = "2025-01-01"
* ^publisher = "Stanford Spezi"
...
* ^url = "http://spezi.stanford.edu/fhir/ValueSet/ios-text-content-type-valueset"
* ^version = "1.0.0"
* ^status = #active
* ^date = "2025-01-01"
* ^publisher = "Stanford Spezi"
